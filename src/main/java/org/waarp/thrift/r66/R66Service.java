...
public class R66Service {
	...
	public interface Iface {
		 ...
		 * the remote host UID.
		 * @param fromuid UID of requester 
		 * @param touid UID of the requested 
		 * @param tid the ID of Transfer
		 ...
		 * @param request
		 * @return The list of String as output from Query
		 * @throws org.apache.thrift.TException
		 */
	...
	public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I>
		...
		private static class transferRequestQuery<I extends Iface> extends
				org.apache.thrift.ProcessFunction<I, transferRequestQuery_args> {
			public transferRequestQuery() {
				super("transferRequestQuery");
			}

			protected transferRequestQuery_args getEmptyArgsInstance() {
				return new transferRequestQuery_args();
			}

			protected transferRequestQuery_result getResult(I iface, transferRequestQuery_args args)
					throws org.apache.thrift.TException {
				transferRequestQuery_result result = new transferRequestQuery_result();
		...
		private static class infoTransferQuery<I extends Iface> extends
				org.apache.thrift.ProcessFunction<I, infoTransferQuery_args> {
			public infoTransferQuery() {
				super("infoTransferQuery");
			}

			protected infoTransferQuery_args getEmptyArgsInstance() {
				return new infoTransferQuery_args();
			}

			protected infoTransferQuery_result getResult(I iface, infoTransferQuery_args args)
					throws org.apache.thrift.TException {
				infoTransferQuery_result result = new infoTransferQuery_result();
		...
		private static class isStillRunning<I extends Iface> extends
				org.apache.thrift.ProcessFunction<I, isStillRunning_args> {
			public isStillRunning() {
				super("isStillRunning");
			}

			protected isStillRunning_args getEmptyArgsInstance() {
				return new isStillRunning_args();
			}

			protected isStillRunning_result getResult(I iface, isStillRunning_args args)
					throws org.apache.thrift.TException {
				isStillRunning_result result = new isStillRunning_result();
		...
		private static class infoListQuery<I extends Iface> extends
				org.apache.thrift.ProcessFunction<I, infoListQuery_args> {
			public infoListQuery() {
				super("infoListQuery");
			}

			protected infoListQuery_args getEmptyArgsInstance() {
				return new infoListQuery_args();
			}

			protected infoListQuery_result getResult(I iface, infoListQuery_args args)
					throws org.apache.thrift.TException {
				infoListQuery_result result = new infoListQuery_result();
