...
public class R66Result implements org.apache.thrift.TBase<R66Result, R66Result._Fields>,
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3985691527101248751L;
	...
	public void unsetGloballaststep() {
		__isset_bit_vector.clear(__GLOBALLASTSTEP_ISSET_ID);
	}
	...
	public boolean isSetGloballaststep() {
		return __isset_bit_vector.get(__GLOBALLASTSTEP_ISSET_ID);
	}

	public void setGloballaststepIsSet(boolean value) {
		__isset_bit_vector.set(__GLOBALLASTSTEP_ISSET_ID, value);
	}
	...
	public int compareTo(R66Result other) {
		...
		if (isSetFromuid()) {
			lastComparison = org.apache.thrift.TBaseHelper
					.compareTo(this.fromuid, typedOther.fromuid);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
